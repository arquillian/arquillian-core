...
@ArquillianIntegrationTest({
        ...
        @TraceStep(name = "test_server", runsWhere = SERVER, order = 2),
        @TraceStep(name = "after_each", runsWhere = SERVER, order = 3),
        @TraceStep(name = "before_each", runsWhere = CLIENT, order = 4),
        @TraceStep(name = "test_client", runsWhere = CLIENT, order = 5),
        @TraceStep(name = "after_each", runsWhere = CLIENT, order = 6),
        @TraceStep(name = "after_all", runsWhere = CLIENT, order = 7),
})
