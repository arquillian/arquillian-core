...
@ArquillianIntegrationTest({
        ...
        @TraceStep(name = "repeated_test_1", runsWhere = CLIENT, order = 2),
        @TraceStep(name = "after_each", runsWhere = CLIENT, order = 3),
        @TraceStep(name = "before_each", runsWhere = CLIENT, order = 4),
        @TraceStep(name = "repeated_test_1", runsWhere = CLIENT, order = 5),
        @TraceStep(name = "after_each", runsWhere = CLIENT, order = 6),
        @TraceStep(name = "before_each", runsWhere = CLIENT, order = 7),
        @TraceStep(name = "repeated_test_1", runsWhere = CLIENT, order = 8),
        @TraceStep(name = "after_each", runsWhere = CLIENT, order = 9),
        @TraceStep(name = "before_each", runsWhere = CLIENT, order = 10),
        @TraceStep(name = "repeated_test_2", runsWhere = CLIENT, order = 11),
        @TraceStep(name = "after_each", runsWhere = CLIENT, order = 12),
        @TraceStep(name = "before_each", runsWhere = CLIENT, order = 13),
        @TraceStep(name = "repeated_test_2", runsWhere = CLIENT, order = 14),
        @TraceStep(name = "after_each", runsWhere = CLIENT, order = 15),
        @TraceStep(name = "before_each", runsWhere = CLIENT, order = 16),
        @TraceStep(name = "repeated_test_2", runsWhere = CLIENT, order = 17),
        @TraceStep(name = "after_each", runsWhere = CLIENT, order = 18),
        @TraceStep(name = "after_all", runsWhere = CLIENT, order = 19),
})
@RunAsClient
