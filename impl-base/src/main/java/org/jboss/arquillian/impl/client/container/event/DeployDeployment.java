 ...
 * @version $Revision: $
 */
public class DeployDeployment implements ContainerControlEvent
{
   private DeployableContainer<?> deployableContainer;
   private DeploymentDescription deployment;
   
   public DeployDeployment(DeployableContainer<?> deployableContainer, DeploymentDescription deployment)
   {
