...
public class ArquillianProxyException extends RuntimeException {
     ...
     *
     * @param message            Message from the proxied Exception
     * @param exceptionClassName Class name of the proxied class type
     * @param reason             reason that the exception couldn't be re-created
     * @param cause              cause from the original exception
     */
